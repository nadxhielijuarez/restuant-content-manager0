...
function userHasAdminRole(roles: unknown, adminRole: string): boolean {
...
export async function requireAdminUser(): Promise<AdminUser> {
  ...
  console.log("userHasAdminRole: " + userHasAdminRole(roles, adminRole));
  // if (!userHasAdminRole(roles, adminRole)) {
  //   throw new UploadThingError("TEST2 - You do not have permission to upload files.");
  // }
